...
public class InventoryIndex
{
	...
	public static int USABLE_ITEM = 1;
	public static int ARMOR = 2;
	public static int HANDHELD_WEAPON = 3;
	public static int STATIONARY_WEAPON = 4;
	public static int STATIONARY_STAFF = 5;
	public static int OFFENSIVE_STAFF = 6;
	public static int SUPPORT_STAFF = 7;
	public static int TILE_STAFF = 8;
	public static int USABLECROP = 9;
	public static int EDIBLECROP = 10;

	public static void initialize()
	{
		int limit = 11;
		index = new List<List<Item>>(limit);
	...
	public static Item getElement(int[] reference)
	{
		...
		try
		{
			return index[reference[0]][reference[1]];
		}
		catch (Exception ex)
		{
			return null;
	...
	public static bool elementsAreEqual(int[] i1, int[] i2)
	{
		return i1[0] == i2[0] && i1[1] == i2[1];
	}

	public static bool moveItemToInventory(List<int[]> inv, int[] item)
	{
		for (int q = 0; q < inv.Count; q++)
		{
			if (elementsAreEqual(inv[q], item))
			{
				inv[q][2] += item[2];
				item[2] = 0;
				return true;
	...
	{
		i.setSpecificItemId(index[type].Count);
		index[type].Add(i);
	}
