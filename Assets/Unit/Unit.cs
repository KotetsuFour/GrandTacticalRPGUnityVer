...
public abstract class Unit : BFTileOccupant
{
	...
	public bool isEnemyOf(Unit o)
	{
		...
		return getAffiliation().isAtWarWith(o.getAffiliation());
	}
	...
	{
		bodyPartsCurrentHP[bodyPart] = Mathf.Min(getCurrentHPOfBodyPart(bodyPart) + amount,
	...
	public abstract bool canCarryUnit();

	public abstract bool canBeCarried();
	...
	public abstract int defense(bool isMagicAttack, int bodyPart);
	...
	public abstract bool isUsingMagic();
	 ...
	 * @return
	 */
	public bool takeDamage(bool isMagicAttack, int bodyPart, int attackPower)
	{
	...
	public bool takeCriticalDamage(bool isMagicAttack, int bodyPart, int attackPower)
	{
	 ...
	 * @return
	 */
	public abstract bool gainExperience(int exp);
